...
const Chatbot = () => {
    ...
    const [messages, setMessages] = useState([
        {
            type: 'bot',
            text: 'Hello! 👋 I\'m the Offkettech AI Assistant. I can tell you everything about our company, services, technologies, and more. How can I help you today?',
    ...
    const knowledgeBase = {
        ...
        company: {
            ...
            response: `Offkettech (${companyDetails.legalName}) is a professional IT services company based in ${companyDetails.address}. Founded in ${companyDetails.founded}, we specialize in:\n\n• Web & Mobile Development\n• AI & Machine Learning\n• Cloud & DevOps\n• Cybersecurity\n• UI/UX Design\n\nWe follow a ${companyDetails.operatingModel} model and are strictly vendor-agnostic, choosing the right technology for each project.`
        },
    ...
    const quickReplies = [
        { text: '🏢 About Company', query: 'Tell me about Offkettech' },
    ...
    return (
        <>
            ...
            <motion.button
                ...
                className="fixed bottom-6 right-6 z-50 w-16 h-16 bg-gradient-to-r from-[#5F27CD] to-[#00D2D3] text-white rounded-full shadow-2xl flex items-center justify-center hover:scale-110 transition-transform"
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="fixed bottom-24 right-6 z-50 w-[420px] max-w-[calc(100vw-3rem)] h-[600px] bg-white rounded-2xl shadow-2xl flex flex-col overflow-hidden border border-slate-200"
                    >
                        {/* Header */}
                        <div className="bg-gradient-to-r from-[#5F27CD] to-[#00D2D3] text-white p-4 flex items-center gap-3">
                            ...
                            <div className="flex-1">
                                <h3 className="font-bold">Offkettech AI Assistant</h3>
