                ...
                <div className="container mx-auto px-6 md:px-12 lg:px-24">
                    <div className="prose prose-invert prose-lg max-w-4xl mx-auto">
                        ...
                        <p className="text-slate-light">
                            Offkettech IT Solutions ("we", "our", or "us") respects your privacy and is committed to protecting your personal data. This privacy policy will inform you as to how we look after your personal data when you visit our website (regardless of where you visit it from) and tell you about your privacy rights and how the law protects you.
                        </p>
            ...
            <section className="section-padding bg-navy-900">
                <div className="container mx-auto px-6 md:px-12 lg:px-24">
                    <div className="prose prose-invert prose-lg max-w-4xl mx-auto">
                        ...
                        <p className="text-slate-light">
                            These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you") and Offkettech IT Solutions ("we", "us", or "our"), concerning your access to and use of the Offkettech website.
                        </p>
                        ...
                        <p className="text-slate-light">
                            These Terms shall be governed by and defined following the laws of India. Offkettech IT Solutions and yourself irrevocably consent that the courts of Hyderabad, India shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these terms.
                        </p>
                    </div>
                </div>
            </section>
